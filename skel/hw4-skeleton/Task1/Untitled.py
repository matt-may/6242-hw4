        ...
        def best_split(self, X, y, indices):
            ...
            for i in indices:
                ...
                for v in xrange(len(vals) - 1):
                    ...
                    if new_gain > gain: gain, fi, thresh = new_gain, i, new_tresh
...
class Utils(object):
    ...
    def gain(parent, child1, child2):
        ...
        n_labs = len(parent)
        return Utils.entropy(parent) -                 (weighted_entropy(child1, n_labs) + weighted_entropy(child2, n_labs))
